...
SECRET_KEY = 'django-insecure-(la2_w(h1w=&j1pryowcxo%rdo_x%$51c-49+0-6n=&e93qdxq'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'), os.path.join(BASE_DIR, 'main', 'templates'), os.path.join(BASE_DIR, 'users', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# this will handle the media files that will be uploaded to the site
MEDIA_URL = 'media/'
