    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(blank=True, max_length=100, verbose_name='Full Name')),
                ('is_teacher', models.BooleanField(default=False, null=True)),
                ('is_student', models.BooleanField(default=False, null=True)),
                ('passkey', models.CharField(default='etyzLRMnAw', editable=False, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_class', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='students', to='users.class')),
            ],
        ),
        migrations.CreateModel(
            name='Subject',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='year_results', to='users.teacherprofile')),
            ],
        ),
        migrations.CreateModel(
            name='TermResult',
